...
<body onload="init()">
	...
	<div class="tabs">
		<a href="javascript:changeTab(1);">Tab 1</a>
		<a href="javascript:changeTab(2);">Tab 2</a>
		<a href="javascript:changeTab(3);">Tab 3</a>
	</div>

	<div class="tabsContent">
	
		<div id="tab_1">I am inside Tab 1 <br>
			<form action="VideoServlet">
				<label>Search Video</label>
				<input name="videoSearch" type="text" />
				<input type="submit" value="Go To Video's">
			</form>
		</div>
		
		<span id="tab_2">I am inside Tab 2 </span>
		<span id="tab_3">I am inside Tab 3 </span>
	</div>
</body>
</html>